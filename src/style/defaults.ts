...
export const DEFAULT_STYLE: IResolvedStyle = {
  ...
  copy: {
    ...
    siwe: {
      ...
      body: "{domain} is requesting to sign in with your Ethereum account. This will not spend tokens or change on-chain balances.",
    ...
    typedData: {
      ...
      body: "Review request details before you confirm.",
      networkLabel: "Network",
    ...
    sendNativeToken: {
      title: "Send",
      body: "Enter the recipient and amount. Network fees are paid from your balance.",
      amountLabel: "Amount",
      amountPlaceholder: "0.0",
      maxLabel: "Max",
      recipientLabel: "Recipient",
      ...
      feeEstimatingLabel: "Estimating…",
      feeEstimateFailedError: "Could not estimate network fee.",
      youSendLabel: "You send",
      theyReceiveLabel: "They receive",
      cancelLabel: "Cancel",
      sendLabel: "Send",
      invalidAmountError: "Enter a valid amount.",
      insufficientBalanceError: "Insufficient balance for amount plus network fee.",
      invalidAddressError: "Enter a valid address or ENS name.",
      sendFailedError: "Send failed.",
    },
    cctpBridge: {
      ...
      speedLabel: "Speed",
      speedFastLabel: "Fast",
      speedSlowLabel: "Standard",
      recipientLabel: "Recipient",
      recipientHint: "Always your wallet on the destination network.",
      ...
      protocolFeeLabel: "CCTP protocol fee",
      cctpFeeLabel: "CCTP fees",
      relayerFeeLabel: "Relayer fee",
      totalBurnLabel: "Total burned",
      netReceivedLabel: "You receive",
      quotingLabel: "Fetching quote…",
      submittingLabel: "Submitting burn…",
      pollingLabel: "Waiting for destination mint…",
      sourceHashLabel: "Source transaction",
      destHashLabel: "Destination mint",
      successTitle: "Bridge complete",
      successBody: "USDC has been minted on the destination network.",
      quoteFailedError: "Could not fetch a bridge quote.",
      submitFailedError: "Bridge failed.",
      timeoutError:
        "Destination mint is taking longer than expected. Retry to keep waiting.",
      insufficientBalanceError:
        "Insufficient USDC for amount, CCTP fees, and relayer fee.",
      invalidAmountError: "Enter a valid amount.",
      noDestinationError: "Select a destination network.",
      viewOnExplorerLabel: "View on explorer",
      doneLabel: "Done",
    },
    grantExecutionPermission: {
      ...
      permissionKindLabel: "Recurring ERC-20 Transfers",
    ...
    grantKitScopeTerms: {
      erc20TransferKindLabel: "Transfer ERC-20 Tokens",
      erc20StreamingKindLabel: "Stream ERC-20 Tokens",
      nativeTransferKindLabel: "Transfer Native Tokens",
      nativeStreamingKindLabel: "Stream Native Tokens",
      nativePeriodTransferKindLabel: "Recurring Native Transfers",
      erc721TransferKindLabel: "Transfer NFT",
      ownershipTransferKindLabel: "Transfer Contract Ownership",
      functionCallKindLabel: "Call Contract Functions",
      tokenLabel: "Token",
      maxAmountLabel: "Max Amount",
      streamDurationLabel: "Stream Duration",
      amountPerPeriodLabel: "Amount per Period",
      resetPeriodLabel: "Reset Period",
      startsLabel: "Starts",
      nftContractLabel: "NFT Contract",
      tokenIdLabel: "Token ID",
      contractLabel: "Contract",
      newOwnerLabel: "New Owner",
      newOwnerAnyLabel: "Set at execution time",
      ownershipWarning:
        "This permission can transfer ownership of a smart contract. Only grant if you trust the app and delegate.",
      allowedContractsLabel: "Allowed Contracts",
      allowedFunctionsLabel: "Allowed Functions",
      maxValueLabel: "Max Value",
      pinnedParametersLabel: "Pinned Parameters",
    },
    grantLiFiSwapPermission: {
      ...
      permissionKindLabel: "Periodic Swap Permission",
      amountLabel: "Periodic Budget",
      transferWindowLabel: "Budget Refresh Period",
      endLabel: "End Time",
      viewOnExplorerLabel: "View on explorer",
      ...
      periodAmountLabel: "Spend up to (per period)",
      periodAmountPlaceholder: "0.0",
      periodDurationLabel: "Period duration (seconds)",
      periodDurationPlaceholder: "86400",
      periodDurationHint: "How often the input budget resets (e.g. 86400 = 1 day).",
      startLabel: "Start Time",
      slippageLabel: "Max slippage",
      slippageHint: "Basis points; 50 = 0.5%. Must be less than 10000.",
      lifiDiamondLabel: "Via LiFi Diamond",
      quoteSignerLabel: "Quotes signed by",
      outputAssetLabel: "Output asset",
      outputRecipientLabel: "Deliver to",
      destinationChainLabel: "Destination chain",
      memoLabel: "Memo",
      memoPlaceholder: "Note for your records",
      invalidAmountError: "Enter a valid period amount.",
      invalidDurationError: "Enter a period duration of at least 1 second.",
      invalidSlippageError: "Enter slippage as an integer between 0 and 9999.",
      rejectLabel: "Reject",
      nextLabel: "Next",
      grantLabel: "Grant",
    },
    grantLiFiApprovePermission: {
      ...
      permissionKindLabel: "Swap Token Approval",
      viewOnExplorerLabel: "View on explorer",
      hostLabel: "App",
      toLabel: "Delegate Account",
      chainLabel: "Network",
      permissionTypeLabel: "Permission",
      tokenLabel: "Token",
      spenderLabel: "Spender (LiFi Diamond)",
      memoLabel: "Memo",
      memoPlaceholder: "Note for your records",
      rejectLabel: "Reject",
      nextLabel: "Next",
    ...
    delegations: {
      ...
      swapSummary: "{amount} {symbol} every {duration} → {dest}",
      approveSummary: "Approve {symbol} for LiFi",
    },
    balances: {
      tabLabel: "Balances",
